...
using HalFuncInOut = int16_t (ProbeSim::*)(uint16_t);
...
static inline const HalFuncInOut HALFns[] = {
    &ProbeSim::_hal_Zero,
    &ProbeSim::_hal_Init,
    &ProbeSim::_hal_SetVcc,
    &ProbeSim::_hal_GetVcc,
    &ProbeSim::_hal_StartJtag,
    &ProbeSim::_hal_StartJtagActivationCode,
    &ProbeSim::_hal_StopJtag,
    &ProbeSim::_hal_Configure,
    &ProbeSim::_hal_GetFuses,
    &ProbeSim::_hal_BlowFuse,
    &ProbeSim::_hal_WaitForEem,
    &ProbeSim::_hal_BitSequence,
    &ProbeSim::_hal_GetJtagId,
    &ProbeSim::_hal_SetDeviceChainInfo,
    &ProbeSim::_hal_SetChainConfiguration,
    &ProbeSim::_hal_GetNumOfDevices,
    &ProbeSim::_hal_GetInterfaceMode,
    &ProbeSim::_hal_GetDeviceIdPtr,
    &ProbeSim::_hal_SyncJtag_AssertPor_SaveContext,
    &ProbeSim::_hal_SyncJtag_Conditional_SaveContext,
    &ProbeSim::_hal_RestoreContext_ReleaseJtag,
    &ProbeSim::_hal_ReadMemBytes,
    &ProbeSim::_hal_ReadMemWords,
    &ProbeSim::_hal_ReadMemQuick,
    &ProbeSim::_hal_WriteMemBytes,
    &ProbeSim::_hal_WriteMemWords,
    &ProbeSim::_hal_EemDataExchange,
    &ProbeSim::_hal_EemDataExchangeAFE2xx,
    &ProbeSim::_hal_SingleStep,
    &ProbeSim::_hal_ReadAllCpuRegs,
    &ProbeSim::_hal_WriteAllCpuRegs,
    &ProbeSim::_hal_Psa,
    &ProbeSim::_hal_ExecuteFunclet,
    &ProbeSim::_hal_ExecuteFuncletJtag,
    &ProbeSim::_hal_GetDcoFrequency,
    &ProbeSim::_hal_GetDcoFrequencyJtag,
    &ProbeSim::_hal_GetFllFrequency,
    &ProbeSim::_hal_GetFllFrequencyJtag,
    &ProbeSim::_hal_WaitForStorage,
    &ProbeSim::_hal_SyncJtag_AssertPor_SaveContextX,
    &ProbeSim::_hal_SyncJtag_Conditional_SaveContextX,
    &ProbeSim::_hal_RestoreContext_ReleaseJtagX,
    &ProbeSim::_hal_ReadMemBytesX,
    &ProbeSim::_hal_ReadMemWordsX,
    &ProbeSim::_hal_ReadMemQuickX,
    &ProbeSim::_hal_WriteMemBytesX,
    &ProbeSim::_hal_WriteMemWordsX,
    &ProbeSim::_hal_EemDataExchangeX,
    &ProbeSim::_hal_SingleStepX,
    &ProbeSim::_hal_ReadAllCpuRegsX,
    &ProbeSim::_hal_WriteAllCpuRegsX,
    &ProbeSim::_hal_PsaX,
    &ProbeSim::_hal_ExecuteFuncletX,
    &ProbeSim::_hal_GetDcoFrequencyX,
    &ProbeSim::_hal_GetFllFrequencyX,
    &ProbeSim::_hal_WaitForStorageX,
    &ProbeSim::_hal_BlowFuseXv2,
    &ProbeSim::_hal_BlowFuseFram,
    &ProbeSim::_hal_SyncJtag_AssertPor_SaveContextXv2,
    &ProbeSim::_hal_SyncJtag_Conditional_SaveContextXv2,
    &ProbeSim::_hal_RestoreContext_ReleaseJtagXv2,
    &ProbeSim::_hal_ReadMemWordsXv2,
    &ProbeSim::_hal_ReadMemQuickXv2,
    &ProbeSim::_hal_WriteMemWordsXv2,
    &ProbeSim::_hal_EemDataExchangeXv2,
    &ProbeSim::_hal_SingleStepXv2,
    &ProbeSim::_hal_ReadAllCpuRegsXv2,
    &ProbeSim::_hal_WriteAllCpuRegsXv2,
    &ProbeSim::_hal_PsaXv2,
    &ProbeSim::_hal_ExecuteFuncletXv2,
    &ProbeSim::_hal_UnlockDeviceXv2,
    &ProbeSim::_hal_MagicPattern,
    &ProbeSim::_hal_UnlockC092,
    &ProbeSim::_hal_HilCommand,
    &ProbeSim::_hal_PollJStateReg,
    &ProbeSim::_hal_PollJStateRegFR57xx,
    &ProbeSim::_hal_IsJtagFuseBlown,
    &ProbeSim::_hal_ResetXv2,
    &ProbeSim::_hal_WriteFramQuickXv2,
    &ProbeSim::_hal_SendJtagMailboxXv2,
    &ProbeSim::_hal_SingleStepJStateXv2,
    &ProbeSim::_hal_PollJStateRegEt8,
    &ProbeSim::_hal_ResetStaticGlobalVars,
    &ProbeSim::_hal_Reset430I,
    &ProbeSim::_hal_PollJStateReg430I,
    &ProbeSim::_hal_PollJStateReg20,
    &ProbeSim::_hal_SwitchMosfet,
    &ProbeSim::_hal_ResetL092,
    &ProbeSim::_hal_DummyMacro,
    &ProbeSim::_hal_Reset5438Xv2,
    &ProbeSim::_hal_LeaSyncConditional,
    &ProbeSim::_hal_GetJtagIdCodeArm,
    &ProbeSim::_hal_ScanApArm,
    &ProbeSim::_hal_MemApTransactionArm,
    &ProbeSim::_hal_ReadAllCpuRegsArm,
    &ProbeSim::_hal_WriteAllCpuRegsArm,
    &ProbeSim::_hal_EnableDebugArm,
    &ProbeSim::_hal_DisableDebugArm,
    &ProbeSim::_hal_RunArm,
    &ProbeSim::_hal_HaltArm,
    &ProbeSim::_hal_ResetArm,
    &ProbeSim::_hal_SingleStepArm,
    &ProbeSim::_hal_WaitForDebugHaltArm,
    &ProbeSim::_hal_MemApTransactionArmSwd,
    &ProbeSim::_hal_GetInterfaceModeArm,
    &ProbeSim::_hal_PollDStatePCRegEt,
    &ProbeSim::_hal_GetCpuIdArm,
    &ProbeSim::_hal_CheckDapLockArm,
    &ProbeSim::_hal_UnlockDap,
    &ProbeSim::_hal_UssSyncConditional,
};
